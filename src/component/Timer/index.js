...
class Timer extends Component {
    ...
    render() {
        ...
        return (
            <div>{
                minutes === undefined || seconds === undefined || hours === undefined ? <span>00:00:00</span>
                    : <span> {hours < 10 ? `0${hours < 0 ? 0 : hours}` : hours}
                    :{minutes < 10 ? `0${minutes < 0 ? 0 : minutes}` : minutes}:
                    {seconds < 10 ? `0${seconds < 0 ? 0 : seconds}` : seconds}</span>
            }
            </div>
        )
    }
